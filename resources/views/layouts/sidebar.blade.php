<div class="col-12 col-lg-3 col-xl-3 vh-100 sidebar">
    ...
    <div class="nav-menu">
        <ul>
            ...
            <x-menu-item name="Category Manager" class="feather-layers" counter="{{ \App\Category::count() }}" link="{{ route('category.index') }}"></x-menu-item>
            <x-menu-item name="Create Article" class="feather-plus-circle" link="{{ route('article.create') }}"></x-menu-item>
            <x-menu-item name="Article List"  class="feather-list" counter="{{ \App\Article::count() }}" link="{{ route('article.index') }}"></x-menu-item>
