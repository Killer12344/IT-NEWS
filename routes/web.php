...
Route::get('/detail/{slug}', 'BlogController@detail')->name('blog.detail');

Route::get('/category/{id}', 'BlogController@baseCategory')->name('blog.category');

Route::get('/user/{id}', 'BlogController@baseUser')->name('blog.user');
